...
public class VendingMachineMainChatGPTHomework {
    ...
    static int[] sold = new int[COUNT];  // 각 제품별 판매 개수
    ...
    private static void getinfo() {
        ...
        for (int i = 0; i < COUNT; i++) {
            if (product[i] != null) {
                strMenu = (i + 1) + "." + product[i] + " : " + price[i] + "원 " + "-" + stock[i] + "개 ";
                System.out.printf(strMenu);
            }
    ...
    private static void userMenu() {
        while (true) {
            ...
            if (menuChoice >= 1 && menuChoice <= COUNT) {
                userMenu2();
                if (money == 0 ) {
                    break;
                }
    ...
    private static void salesConfirm() {
        ...
        for (int i = 0; i < COUNT; i++) {
            if (product[i] != null) {
                int productSales = sold[i] * price[i];
                totalSales += productSales;
                System.out.println(product[i] + " : " + sold[i] + "개 판매 → 매출 " + productSales + "원");
            }
        }
